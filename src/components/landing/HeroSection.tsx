...
const HalftoneGlobeDynamic = dynamic(() => import("@/components/ui/Globe"), {
  ssr: false,
});
      ...
      <div className="flex flex-col items-center justify-end relative z-10">
        ...
        <div className="self-start text-left w-full">
          <h1 className="text-[8vh] leading-snug text-justify text-carbon-medium">
            ...
            <span className="font-semibold border-b-4 border-carbon-light text-carbon-light">
              PoRCE
            </span>{" "}
            are tokenizing climate action to safeguard our shared future.
            <Link
              href={"/marketplace"}
              className="text-[4vh] px-4 py-2 bg-carbon-light hover:bg-white hover:text-carbon-darkest text-carbon-darkest border-4 border-carbon-light cursor-pointer ml-8 align-middle rounded-sm font-semibold transition-all"
            >
              Get Started ⟶
            </Link>
          </h1>
