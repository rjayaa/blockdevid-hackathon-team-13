...
const AssetCard = ({ asset }: { asset: UserAsset }) => {
    ...
    return (
        <Card className="border-2 border-foreground hover:shadow-2xl transition-all bg-carbon-medium/50">
            <CardHeader>
            ...
            <CardFooter className="flex justify-between pt-4">
                ...
                <Button 
                    variant="outline" 
                    className="border-2 border-foreground bg-carbon-light hover:bg-carbon-medium uppercase text-xs font-bold"
                    onClick={() => { alert(`Redirecting to /retire?token=${asset.tokenId}`)}}
                >
                    Retire Tokens
                </Button>
            </CardFooter>
...
const CertificateCard = ({ cert }: { cert: Certificate }) => {
    ...
    return (
        <Card className="border-2 border-foreground bg-carbon-light hover:shadow-xl transition-all">
            <CardHeader className="p-4 border-b-2 border-foreground/50">
